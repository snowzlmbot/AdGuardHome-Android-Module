...
grep -F 'id="createBackup"' "$ROOT/module/webroot/index.html" >/dev/null || fail 'backup control missing'
grep -F 'CONTROL} backup' "$ROOT/module/webroot/app.js" >/dev/null || fail 'backup command missing'
