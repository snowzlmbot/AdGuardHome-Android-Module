...
IPTABLES_BIN="$ROOT/tests/fixtures/iptables-recording-bin/iptables" IP6TABLES_BIN="$ROOT/tests/fixtures/iptables-recording-bin/ip6tables" sh "$ROOT/module/scripts/firewall/firewall-worker.sh" once || fail 'initial ensure failed'
...
IPTABLES_BIN="$ROOT/tests/fixtures/iptables-recording-bin/iptables" IP6TABLES_BIN="$ROOT/tests/fixtures/iptables-recording-bin/ip6tables" sh "$ROOT/module/scripts/firewall/firewall-worker.sh" once || fail 'repeat ensure failed'
...
IPTABLES_BIN="$ROOT/tests/fixtures/iptables-recording-bin/iptables" IP6TABLES_BIN="$ROOT/tests/fixtures/iptables-recording-bin/ip6tables" sh "$ROOT/module/scripts/firewall/firewall-worker.sh" once || fail 'unsafe core state caused worker failure'
