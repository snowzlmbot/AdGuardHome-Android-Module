...
> Version 0.1.0 did not install the lifecycle entrypoints when `SKIPUNZIP=1` was used. Upgrade or reinstall 0.1.7; existing generated ports and credentials are preserved.
